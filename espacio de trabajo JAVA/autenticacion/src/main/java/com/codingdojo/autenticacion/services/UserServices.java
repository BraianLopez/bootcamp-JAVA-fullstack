package com.codingdojo.autenticacion.services;
...
import com.codingdojo.autenticacion.repositories.UserRepo;
...
public class UserServices {
	...
	public User registroUsuario(User user, BindingResult resultado) {
		...
		if (usuarioRegistrado != null) {
			resultado.rejectValue("email", "Unique", "el correo ingresado ya existe");
		}
